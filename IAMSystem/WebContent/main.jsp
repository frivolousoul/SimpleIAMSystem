...
<body>
	<div id="main-content">
		<div id="header" class="jumbotron">
			...
			<h3 class="text-center" style="color: #DCDCDC">Your Reliable Identity Manager</h3>
		</div>
		<div class="container-fluid">
			...
			<div class="tab-content">
				...
				<div role="tabpanel" id="tab_create" class="tab-pane fade"></div>
			...
			<%}%>
				...
				$("#tabCreate").on("click", function() {
					loadData('create.jsp', '#tab_create');
				});

				$('#btn_postReq').on('click', function() {
					var form = $('#searchForm');
					var deferred = $.ajax({
						type : "POST",
